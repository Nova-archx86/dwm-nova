...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_lime,  col_lime  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_lime, "-sf", col_gray4, "-l", "10", NULL };
